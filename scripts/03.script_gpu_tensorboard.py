...
#result
with profiler.profile(activities=[ProfilerActivity.CPU, ProfilerActivity.CUDA], record_shapes=True, on_trace_ready=profiler.tensorboard_trace_handler( '../log/attention_gpu')) as prof:
   output, attention_weights = attention_layer(input_tokens)
